...
export default function SobrePage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <div className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_top_left,_rgba(249,115,22,0.2),_transparent_40%)]" />
      ...
      >
        <div className="flex-1 space-y-8">
          <span className="inline-flex items-center gap-2 rounded-full border border-orange-400/40 bg-orange-500/10 px-4 py-1 text-[11px] uppercase tracking-[0.35em] text-orange-200">
            manifesto geek
          </span>
          <h1 className="text-4xl text-orange-200 drop-shadow-[0_0_25px_rgba(249,115,22,0.45)] lg:text-5xl">
            Uma carta de amor ao universo dos animes
          </h1>
          <p className="max-w-2xl text-xl leading-relaxed text-zinc-100">
        ...
        <div className="flex-1">
          <div className="relative overflow-hidden rounded-3xl border border-orange-300/40 bg-[rgba(28,5,8,0.85)] p-8 shadow-[0_0_40px_rgba(249,115,22,0.3)]">
      ...
      >
        <div className="rounded-3xl border border-orange-400/30 bg-[rgba(24,4,8,0.85)] p-10 shadow-[0_0_45px_rgba(249,115,22,0.28)]">
